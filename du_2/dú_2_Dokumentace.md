...
Následně jsou detekovány případné mezery v datech. Mezery jsou zařazené do sedmidenních průtoků, ale nepočítá se s nima. Naposled program kontroluje zda je průtok náhodou průtok není záporný (chyba č. 8), pokud chyba nastane, program záznam přeskočí a pokračuje dalším záznamem.<br/>
