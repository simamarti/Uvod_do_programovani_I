...
### Zpracování dat
Pomocí objektu csv.reader() program nejprve zkontroluje zda soubor existuje (chyba č. 1), zda k němu má uživatel práva pro čtení/zápis (chyba č. 2), nebo zda není prázdný (chyba č. 3), nebo zda nenastane nějaká jiná neočekávatelná chba spojená se čtením/zápisem do souboru (chyba č. 4). Pokud nastane některá z předchozích chyb, program skončí.<br/>
...
Následně jsou detekovány případné mezery v datech. Mezery jsou zařazené do sedmidenních průtoků, ale nepočítá se s nima. Naposled program kontroluje zda je průtok náhodou průtok není záporný (chyba č. 9), pokud chyba nastane, program záznam přeskočí a pokračuje dalším záznamem.<br/>
